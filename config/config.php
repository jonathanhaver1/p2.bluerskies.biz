...
# Default DB name for this app
	define('DB_NAME', 'p2_bluerskies_biz'); 
...
# For this you could use gmail SMTP or something like http://sendgrid.com/
	...
	define('SMTP_USERNAME', 'jonathanhaverkampf@gmail.com');
	define('SMTP_PASSWORD', 'Bezug532light');

# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'qzewe38q3w42wzteqwer');
	define('TOKEN_SALT', 'hs6w7q74as23zsh38d');